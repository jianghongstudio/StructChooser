...
namespace UE::StructChooserEditor
{
	...
	TSharedRef<FChooserColumnDragDropOp> FChooserColumnDragDropOp::New(TSharedPtr<FStructChooserTableViewModel> InViewModel, uint32 InColumnIndex)
	{
	...
	void SStructChooserColumnHandle::Construct(const FArguments& InArgs)
	{
	...
	FReply SStructChooserColumnHandle::OnMouseButtonDown(const FGeometry& MyGeometry, const FPointerEvent& MouseEvent)
	{
	...
	FReply SStructChooserColumnHandle::OnDragDetected(const FGeometry& MyGeometry, const FPointerEvent& MouseEvent)
	{
	...
	void SStructChooserColumnHandle::OnDragEnter(const FGeometry& MyGeometry, const FDragDropEvent& DragDropEvent)
	{
	...
	void SStructChooserColumnHandle::OnDragLeave(const FDragDropEvent& DragDropEvent)
	{
		bDragActive = false;
	}

	FReply SStructChooserColumnHandle::OnDragOver(const FGeometry& MyGeometry, const FDragDropEvent& DragDropEvent)
	{
		DragActiveCounter = 2;
		bDragActive = true;
	...
	FReply SStructChooserColumnHandle::OnDrop(const FGeometry& MyGeometry, const FDragDropEvent& DragDropEvent)
	{
		bDragActive = false;
