...
public:
	...
	static TSharedRef<FChooserColumnDragDropOp> New(TSharedPtr<FStructChooserTableViewModel> InViewModel, uint32 InColumnIndex);
};

class SStructChooserColumnHandle : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SStructChooserColumnHandle)
	{}
