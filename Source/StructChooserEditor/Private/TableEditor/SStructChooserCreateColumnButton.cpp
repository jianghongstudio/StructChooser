...
namespace UE::StructChooserEditor
{
	...
	TSharedRef<SWidget>	SStructChooserCreateColumnButton::MakeCreateColumnMenu()
    {
	...
	void SStructChooserCreateColumnButton::Construct(const FArguments& InArgs)
	{
		...
		[
			SNew(SPositiveActionButton)
            	...
            	.OnGetMenuContent(this, &SStructChooserCreateColumnButton::MakeCreateColumnMenu)
		];

	}

	SStructChooserCreateColumnButton::~SStructChooserCreateColumnButton()
	{
	}
