...
#include "StructChooserTableEditor.generated.h"

class SComboButton;
class SPositiveActionButton;
class SEditableText;
class IDetailsView;
class UStructChooserRowDetails;

namespace UE::StructChooserEditor
{
	class SStructChooserTableWidget;
	class SStructNestedChooserTree;
	struct FStructChooserTableRow;

	class FStructChooserTableEditor : public FAssetEditorToolkit
	{
	public:
		...
		*/
		...
		FStructChooserTableEditor();
		
		/** Destructor */
		virtual ~FStructChooserTableEditor();
		...
		{
			return FStructChooserTableEditor::StructChooserTableToolbarName;
		}
	...
	private:
		...
		TSharedPtr<SStructChooserTableWidget> ChooserTableWidget;
	...
	public:
		...
		static const FName StructChooserTableToolbarName;
		static const FName StructChooserEditorAppIdentifier;

		TSharedPtr<SStructNestedChooserTree> NestedChooserTree;

		/** The name given to all instances of this type of editor */
		static const FName ToolkitFName;

		static TSharedRef<FStructChooserTableEditor> CreateEditor( const EToolkitMode::Type Mode, const TSharedPtr< IToolkitHost >& InitToolkitHost, UObject* ObjectToEdit, FGetDetailsViewObjects GetDetailsViewObjects = FGetDetailsViewObjects() );

		static TSharedRef<FStructChooserTableEditor> CreateEditor( const EToolkitMode::Type Mode, const TSharedPtr< IToolkitHost >& InitToolkitHost, const TArray<UObject*>& ObjectsToEdit, FGetDetailsViewObjects GetDetailsViewObjects = FGetDetailsViewObjects() );
...
/** Tool menu context for StructChooser table editor (UE5.7: engine context has no ViewModel). */
UCLASS()
class UStructChooserEditorToolMenuContext : public UObject
{
	GENERATED_BODY()
