...
{
	using UE::ChooserEditor::FOpenObject;
	using UE::ChooserEditor::FShowDetails;
	using UE::ChooserEditor::IChooserTableViewModel;
	using UE::ChooserEditor::IChooserTableWidgetInterface;
	...
	class FStructChooserTableViewModel : public IChooserTableViewModel, public IChooserTableWidgetInterface, public FSelfRegisteringEditorUndoClient
	{
	public:
		virtual ~FStructChooserTableViewModel() override;
		FStructChooserTableViewModel(UChooserTable* Chooser);
		...
		TStrongObjectPtr<UStructChooserColumnDetails> SelectedColumn;
		TArray<TObjectPtr<UStructChooserRowDetails>> SelectedRows;
		// cache of objects to reuse for SelectedRows
		TArray<TStrongObjectPtr<UStructChooserRowDetails>> SelectedRowsCache;
		...
		void QueueRowTransaction(UStructChooserRowDetails* RowDetails);
	...
	private:
		...
		TArray<TWeakObjectPtr<UStructChooserRowDetails>> QueuedRowTransactions;
	};
