...
public:
	...
	static TSharedRef<FChooserRowDragDropOp> New(TSharedPtr<FStructChooserTableViewModel> InViewModel, uint32 InRowIndex);

	virtual void OnDrop(bool bDropWasHandled, const FPointerEvent& MouseEvent) override;
};

class SStructChooserRowHandle : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SStructChooserRowHandle)
	{}
